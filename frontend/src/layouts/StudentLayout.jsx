...
import { Brain, LayoutDashboard, FileText, CheckCircle, LogOut, Menu, X } from 'lucide-react';
    ...
    <div className="flex h-screen bg-[#f8fafc] font-sans overflow-hidden">
      ...
      <div className="fixed top-0 left-0 right-0 h-14 bg-[#1a2b3c] text-white flex items-center px-4 z-40 lg:hidden">
        ...
        <div className="flex items-center gap-2 ml-3">
          <div className="bg-[#1176b6] p-1 rounded-md">
            <Brain className="w-4 h-4 text-white" />
          </div>
          <span className="font-bold text-sm tracking-wide">ExamSiswa</span>
        </div>
      </div>
