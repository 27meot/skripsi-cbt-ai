    ...
    <AdminLayout>
      <div className="h-16 flex items-center justify-between px-8 bg-white border-b border-gray-200 shrink-0">
        <div className="flex items-center gap-4">
          <Link to="/siswa" className="text-gray-400 hover:text-[#0ea5e9] transition">
            <ArrowLeft className="w-5 h-5" />
          </Link>
          <div>
            <h1 className="font-bold text-gray-800 text-lg">Detail Siswa: {siswa?.name || 'Loading...'}</h1>
            <p className="text-xs text-gray-500 font-medium mt-0.5">Riwayat pengerjaan ujian dan koreksi</p>
          </div>
        </div>
      </div>
