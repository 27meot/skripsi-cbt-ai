    ...
    <AdminLayout>
      <div className="min-h-14 md:h-16 flex flex-col md:flex-row items-start md:items-center justify-between px-4 md:px-8 py-2 md:py-0 gap-2 bg-white border-b border-gray-200 shrink-0">
        <div className="flex items-center gap-3 md:gap-4 min-w-0">
          ...
          <div>
            <h1 className="font-bold text-gray-800 text-sm md:text-lg truncate">Koreksi: {data?.user?.name}</h1>
            <p className="text-xs text-gray-500 font-medium mt-0.5 hidden md:block">{data?.ujian?.title}</p>
          </div>
        </div>
